...
def getStopMassPoints(neutralinopoint):
    ...
    stopMassDict = {
        ...
        50: range(150, 800, 25),
        75: range(175, 800, 25),
        100: range(200, 800, 25),
        125: range(225, 800, 25),
        150: range(250, 800, 25),
        175: range(275, 800, 25),
        200: range(300, 800, 25),
        225: range(325, 800, 25),
        250: range(350, 800, 25),
        275: range(375, 800, 25),
        300: range(400, 800, 25),
        325: range(425, 800, 25),
        350: range(450, 800, 25),
        375: range(475, 800, 25),
        400: range(500, 800, 25),
        425: range(525, 800, 25),
        450: range(550, 800, 25),
        475: range(575, 800, 25),
        500: range(600, 800, 25),
        525: range(625, 800, 25),
        550: range(650, 800, 25),
        575: range(675, 800, 25),
        600: range(700, 800, 25),
        625: range(725, 800, 25),
        650: range(750, 800, 25),
        675: range(775, 800, 25),
        700: 800,
       }
