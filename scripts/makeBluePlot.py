...
def Binning(Box, noBtag):
    if Box == "TauTau" or Box == "Had":    
        ...
        if noBtag == False: Rsqbins = [0.11, 0.13, 0.15, 0.18, 0.21, 0.24, 0.27, 0.3, 0.35, 0.4, 0.5, 0.65, 0.8, 1.5]
        else: Rsqbins = [0.11, 0.13, 0.15, 0.18, 0.21, 0.24, 0.27, 0.3, 0.35, 0.4, 0.5]
