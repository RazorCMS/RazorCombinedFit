...
## data.add(a)
        ...
        weight = 0.95
        lepw_nominal = 1.
        nominal.Fill(MR, RSQ, btag_nominal, weight*btagw_nominal*lepw_nominal*isrw_nominal)
        
        #err
        jes_up.Fill (tree.MR_JES_UP , tree.RSQ_JES_UP , btag_nominal, weight*btagw_nominal*lepw_nominal*isrw_nominal)
        jes_down.Fill (tree.MR_JES_DOWN, tree.RSQ_JES_DOWN, btag_nominal, weight*btagw_nominal*lepw_nominal*isrw_nominal)
        btag_up.Fill (MR , RSQ , btag_nominal , weight*btagw_up*lepw_nominal*isrw_nominal )
        btag_down.Fill(MR , RSQ , btag_nominal , weight*btagw_dw*lepw_nominal*isrw_nominal )
        isr_up.Fill (MR , RSQ , btag_nominal, weight*isrw_up*btagw_nominal*lepw_nominal )
        isr_down.Fill (MR , RSQ , btag_nominal, weight*isrw_dw*btagw_nominal*lepw_nominal )
        lep_up.Fill (MR , RSQ , btag_nominal, weight*lepw_up*btagw_nominal*isrw_nominal )
        lep_down.Fill (MR , RSQ , btag_nominal, weight*lepw_dw*btagw_nominal*isrw_nominal )
        ...
        for icteq in range(45):
            vwHisto_pdfCTEQ[icteq].Fill(MR, RSQ, btag_nominal, weight*btagw_nominal*lepw_nominal*isrw_nominal*CTEQ66_W[icteq])
        for innpdf in range(101):
            vwHisto_pdfNNPDF[innpdf].Fill(MR, RSQ, btag_nominal, weight*btagw_nominal*lepw_nominal*isrw_nominal*NNPDF_W[innpdf])
