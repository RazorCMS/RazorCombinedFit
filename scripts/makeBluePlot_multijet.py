...
def Binning(Box, noBtag):
    ...
    elif Box == "BJet" or Box == "BJetHS" or Box == "BJetLS" or Box == "CR6JBVetoHS" or Box == "CR6JBVetoLS" \
            or Box == "CR6JSingleLeptonBVetoHS" or Box == "CR6JSingleLeptonBVetoLS":
        MRbins = [450.0, 550.0, 650.0, 790.0, 1000, 1500, 2200, 3000, 4000.0]
        Rsqbins = [0.03, 0.075, 0.12, 0.2, 0.3, 0.4, 0.5, 0.7, 1.0]
        #MRbins = [450.0, 500.0, 550.0, 600.0, 650.0, 720.0, 800, 900, 1000, 1200, 1500, 1800, 2300, 3000, 4000.0]
        #Rsqbins = [0.03, 0.075, 0.12, 0.2, 0.3, 0.4, 0.5, 0.7, 1.0]
    else:
