...
for i in range(1100,2100):
    ...
    outputfile.write("python scripts/runAnalysis.py -c SingleBoxFit_Prompt_MR300.0_R0.3_B123hC123_new2.cfg -a SingleBoxFit %s -i %s --save-toys-from-fit /tmp/mpierini/toy%s_%i --scale-lumi 1000 -t 100 >& /dev/null \n" %(inputFile, inputFit, box, i))
    ...
    outputfile.write("python scripts/expectedYield.py 1000 /tmp/mpierini/expectedYield_%s_%i.root %s /tmp/mpierini/toy%s_%i/*root\n" %(box, i, box, box, i))
