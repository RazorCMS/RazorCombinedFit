    ...
    def limit(self, inputFiles, nToys):
        ...
        for box, fileName in fileIndex.iteritems():
            ...
            if boxes[box].name == "Mu" or boxes[box].name == "Ele":
                boxes[box].workspace.var("MR").setRange("sR1bis", 800., 3500)
                boxes[box].workspace.var("Rsq").setRange("sR1bis", 0.09, 0.198)
                boxes[box].workspace.var("MR").setRange("sR2bis", 650., 3500)
                boxes[box].workspace.var("Rsq").setRange("sR2bis", 0.2, 0.298)
                boxes[box].workspace.var("MR").setRange("sR3bis", 450., 3500)
                boxes[box].workspace.var("Rsq").setRange("sR3bis", 0.30, 0.448)
                boxes[box].workspace.var("MR").setRange("sR4bis", 400., 3500)
                boxes[box].workspace.var("Rsq").setRange("sR4bis", 0.45, 0.498)
            if boxes[box].name == "Had":
                boxes[box].workspace.var("MR").setRange("sR1bis", 800., 3500)
                boxes[box].workspace.var("Rsq").setRange("sR1bis", 0.16, 0.198)
                boxes[box].workspace.var("MR").setRange("sR2bis", 650., 3500)
                boxes[box].workspace.var("Rsq").setRange("sR2bis", 0.2, 0.298)
                boxes[box].workspace.var("MR").setRange("sR3bis", 450., 3500)
                boxes[box].workspace.var("Rsq").setRange("sR3bis", 0.30, 0.448)
