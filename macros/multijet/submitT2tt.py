...
if __name__ == "__main__":
    ...
    fitName = "root://eoscms//eos/cms/store/cmst3/user/wreece/Razor2011/MultiJetAnalysis/FitResults/razorMJ_Penalties_Staircase_Combi_All.root"
    ...
    for tree in treeList:
        cmd = "python runMDLimit_SMS.py --multijet -t 30 -i %i -n 150 -q 8nh --xsec %f --input %s --tree_name %s --config %s %s" % (index,xsec,fitName,tree,config,SMSTree)
        print cmd
        #print 'sleep 120'
