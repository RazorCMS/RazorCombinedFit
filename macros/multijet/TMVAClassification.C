...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   factory->AddVariable( "thetaH1","thetaH1", "rad", 'F' );
   factory->AddVariable( "thetaH2","thetaH2", "rad", 'F' );
   factory->AddVariable( "topMass1","topMass1", "GeV", 'F' );
   ...
   TTree *signal     = (TTree*)input5->Get("RMRTree");
   TTree *background1 = (TTree*)input1->Get("RMRTree");
