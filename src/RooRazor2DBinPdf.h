//---------------------------------------------------------------------------
#ifndef ROO_Razor2DBinPdf
#define ROO_Razor2DBinPdf
//---------------------------------------------------------------------------
#include "RooAbsPdf.h"
...
//---------------------------------------------------------------------------
class RooRazor2DBinPdf : public RooAbsPdf
{
public:
   RooRazor2DBinPdf() {} ;
   RooRazor2DBinPdf(const char *name, const char *title,
		    RooAbsReal& _th1x,
		    RooAbsReal& _x0, RooAbsReal& _y0,
		    RooAbsReal& _b, RooAbsReal& _n,
		    RooAbsReal& _xCut, RooAbsReal& _yCut,
		    TH2* _Hnominal);
   RooRazor2DBinPdf(const RooRazor2DBinPdf& other,
      const char* name = 0);
   virtual TObject* clone(const char* newname) const { return new RooRazor2DBinPdf(*this,newname); }
   inline virtual ~RooRazor2DBinPdf() { }
...
private:
  ClassDef(RooRazor2DBinPdf,1) // Razor2DTail_SYS function
